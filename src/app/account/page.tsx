    ...
    <>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-12 md:py-16 space-y-12">
          ...
          <Link href="/email-preferences" className="block group">
            <section className="flex items-center gap-4 bg-primary/5 border border-primary/10 rounded-xl p-6 hover:border-primary/30 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-primary shrink-0">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
              <div className="flex-1">
                <h2 className="text-base font-bold text-slate-100">Email Preferences</h2>
                <p className="text-xs text-slate-400 mt-0.5">Manage your email subscription and notification settings.</p>
              </div>
              <span className="text-primary text-sm font-bold group-hover:translate-x-1 transition-transform shrink-0">
                &rarr;
              </span>
            </section>
          </Link>
