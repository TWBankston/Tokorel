        ...
        <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12 space-y-24">
          <section className="text-center space-y-6">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Your exclusive access to the Tokorel Universe library. Download books, novellas, and companion content.
            </p>
          </section>
          ...
          <section className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {BOOKS.map((book) => (
                <div
                  key={book.title}
                  className="bg-primary/5 border border-primary/10 p-6 rounded-xl hover:bg-primary/10 transition-all group"
                >
          ...
          <section className="text-center py-24 bg-gradient-to-t from-primary/10 to-transparent rounded-3xl border border-primary/5">
            ...
            <p className="text-slate-400 max-w-xl mx-auto mb-10 text-lg">
              Return to your command center for the full Tokorel Universe experience.
            </p>
            <Link
              href="/portal"
